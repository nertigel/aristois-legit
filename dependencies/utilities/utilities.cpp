...
bool utilities::weaponchecks::is_pistol(void* weapon) {
	if (!weapon)
		return false;
...
bool utilities::weaponchecks::is_smg(void* weapon) {
	if (!weapon)
		return false;
...
bool utilities::weaponchecks::is_rifle(void* weapon) {
	if (!weapon)
		return false;
...
bool utilities::weaponchecks::is_heavy(void* weapon) {
	if (!weapon)
		return false;
...
bool utilities::weaponchecks::is_sniper(void* weapon) {
	if (!weapon)
		return false;
...
bool utilities::weaponchecks::is_knife(void* weapon) {
	if (!weapon)
		return false;
...
bool utilities::weaponchecks::is_grenade(void* weapon) {
	if (!weapon)
		return false;
...
bool utilities::weaponchecks::is_bomb(void* weapon) {
	if (!weapon)
		return false;
