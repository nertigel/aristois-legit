...
public:
	...
	void setup_fonts() {
		...
		interfaces::surface->set_font_glyph(name_font, "Verdana", 13, 500, 0, 0, font_flags::fontflag_antialias | font_flags::fontflag_dropshadow | font_flags::fontflag_outline);
	}
